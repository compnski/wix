...
(function() {
  ...
  App.AppFrame = (function(superClass) {
    ...
    AppFrame.prototype.render = function() {
      return React.createElement("div", {
        "className": 'app-frame'
      }, React.createElement(App.StatusBarComponent, null), React.createElement(App.MapComponent, {
  ...
  App.Map = (function() {
    function Map() {
      this.mapData = this.genMapData(14, 19);
    }
  ...
  App.OverworldFlow = (function(superClass) {
    ...
    OverworldFlow.prototype.execute = function() {
      ...
      return E.bind('tile_clicked', this.tileClicked);
    };
    ...
    OverworldFlow.prototype.tileClicked = function(data) {
      ...
      return console.log(data, this.map.mapData[data.r][data.c]);
    };
  ...
  App.SetupFlow = (function(superClass) {
    ...
    SetupFlow.prototype.execute = function() {
      ...
      return App.BaseFlow.setNextFlow(new App.OverworldFlow(mapData));
    };
